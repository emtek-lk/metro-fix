...
const styles: Record<string, CSSProperties> = {
  screen: {
    ...
    background: 'linear-gradient(135deg, #1b2d2f 0%, #203b40 36%, #2b435f 100%)',
    overflow: 'hidden',
  },
  screenCompact: {
    height: 'auto',
  ...
  rightPanel: {
    ...
    background: 'linear-gradient(180deg, rgba(251, 253, 253, 0.98) 0%, rgba(242, 247, 246, 0.98) 100%)',
  ...
  tabRow: {
    ...
    padding: '6px',
    borderRadius: '18px',
    background: 'rgba(16, 36, 38, 0.05)',
    border: '1px solid rgba(16, 36, 38, 0.06)',
  ...
  formSurface: {
    ...
    background: 'linear-gradient(180deg, rgba(255,255,255,0.94) 0%, rgba(248,251,251,0.96) 100%)',
    border: '1px solid rgba(16, 36, 38, 0.06)',
  ...
  demoCard: {
    ...
    padding: '14px 16px',
    borderRadius: '18px',
    background: 'linear-gradient(180deg, rgba(255,255,255,0.88) 0%, rgba(244,248,247,0.98) 100%)',
    border: '1px solid rgba(16, 36, 38, 0.08)',
